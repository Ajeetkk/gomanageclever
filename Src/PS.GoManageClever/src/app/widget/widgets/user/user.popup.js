...
export default function UserPopups(props) {
    ...
    const resendView = () => {
        return (<div>
            <p>An invitation email has already been sent to the user.<br /> Are you sure you want to resend invitation to {props.PopData.email}?</p>
        </div>)
    }
    ...
    const deleteView = () => {
        return (<div>
            <p>Are you sure you want to remove "{props.PopData.alternateEmail}"?</p>
        </div>)
    }
    ...
    const roleView = () => {
        return (
            <div>
                ...
                <AssignRole roles={props.FilterData} SelectedRole={selectedRole} SelectedId={props.PopData.modules != null? props.PopData.modules : []} />
            </div>)
    }
    ...
    const savePopup = () => {
        if (props.PopupName === 'Invite') {
            ...
            props.Submit(props.PopupName, roleList);
        }
        else {
