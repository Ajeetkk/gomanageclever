...
export default function AdditionalServicePartnerView(props) {
  ...
  return (
    <div className="pagewrapper">
      <Row className="subHeader">
        ...
        <Col md={6} className="searchwrapper">
          {open ? <Button
            ...
            btnClass="btn btn-primary width-auto"
      ...
      >
        <div className="service-modal">
          <p>Are you sure you want to remove {props.ServicePartnerName}? This service partner will no longer be associated to your assets. </p>
        </div>
      </Modal>
    </div>
  );
