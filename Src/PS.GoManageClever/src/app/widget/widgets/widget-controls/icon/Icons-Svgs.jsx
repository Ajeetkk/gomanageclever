...
export default function Icons(props) {
  ...
  const AssignTextIcon = () => {
    return (
      <span className="btn btn-link">Assign</span>
    )
  };

  const ReassignTextIcon = () => {
    return (
      <span className="btn btn-link">RA</span>
    )
  };
  const UnassignTextIcon = () => {
    return (
      <span className="btn btn-link">UA</span>
    )
  };
  ...
  const selectIcon = () => {
    switch (props.IconName) {
      ...
      case  'reassignTextIcon':
        return  (<React.Fragment>{ReassignTextIcon()}</React.Fragment>);
      case  'unassignTextIcon':
        return  (<React.Fragment>{UnassignTextIcon()}</React.Fragment>);
