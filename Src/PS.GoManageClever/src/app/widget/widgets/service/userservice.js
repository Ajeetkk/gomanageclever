...
export default class UserService {
    ...
    deleteuser(userId) {
        return this.baseApiService.patch(`${this.BaseUrl}/users/${userId}/deactivate`, {}, false).then(data => {
            if (data.status !== 200) {
                ...
                this.baseApiService.success('User removed successfully');
            }
            return data;
        });
    }
    ...
    //                 this.baseApiService.error(data.title);
    //             } else {
    //                 this.baseApiService.success('User reactivated successfully');
    //             }
    //             return data;
    //         });
    // }
    ...
    updateRoles(roleData, userId) {
        return this.baseApiService.put(`${this.BaseUrl}/users/${userId}/roles`, roleData, true)
            .then(data => {
                if (data.status !== 200) {
                    this.baseApiService.error(data.title);
                } else {
                    this.baseApiService.success('Role updated sucessfully');
                }
                return data;
            });
    }

    updateInviteUserRoles(roleData, userId) {
        return this.baseApiService.put(`${this.BaseUrl}/userinvitations/${userId}/roles`, roleData, true)
            .then(data => {
                if (data.status !== 200) {
                    this.baseApiService.error(data.title);
                } else {
                    this.baseApiService.success('Role updated successfully');
                }
                return data;
            });
    }
        ...
        return this.baseApiService.post(`${this.BaseUrl}/userinvitations/${userId}/resend`, {}, false)
            .then(data => {
                if (data.status !== 200) {
                    ...
                    this.baseApiService.success('Invitation resend successfully');
                }
                return data;
            });
    }
        ...
        return this.baseApiService.delete(`${this.BaseUrl}/userinvitations/${userId}`, true)
            .then(data => {
                if (data.status !== 200) {
                    ...
                    this.baseApiService.success('Invitation revoked successfully');
                }
                return data;
            });
    }
